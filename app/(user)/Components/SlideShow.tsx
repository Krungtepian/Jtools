    ...
    <div id="default-carousel" className="relative w-full h-full" data-carousel="slide">
        <div className="relative h-auto overflow-hidden rounded-lg md:h-96">
            <div className=" duration-700 ease-in-out" data-carousel-item>
                <img src="https://cdn.discordapp.com/attachments/1129443288097759322/1155516155872690217/jtool_pic_1.png" className="m-0  p-0 bg-cover bg-no-repeat bg-fixed bg-center " alt="..."></img>
            </div>
